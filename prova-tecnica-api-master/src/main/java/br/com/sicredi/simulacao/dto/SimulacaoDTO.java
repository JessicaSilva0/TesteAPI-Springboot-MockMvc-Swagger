...
public class SimulacaoDTO {
    ...
    @ApiModelProperty(position = 2, required = true, example = "97package br.com.sicredi.simulacao.dto;
...
public class SimulacaoDTO {
    ...
    public SimulacaoDTO(Long id, String nome, String cpf, String email, int valor, Integer parcelas, boolean seguro) {
        this.id = id;
        this.nome = nome;
        this.cpf = cpf;
        this.email = email;
